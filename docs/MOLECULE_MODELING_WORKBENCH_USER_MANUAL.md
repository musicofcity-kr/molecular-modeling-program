...
작성일: 2026-07-03
상태: Classroom MVP Release Candidate with Firebase 제출/AI 피드백 흐름
...
4. 학생은 예측, 구조 그리기, 구조 확인, 3D 관찰, 정리 문항을 작성합니다.
5. `교사에게 제출하기`를 누르면 현재 브라우저 제출함에 저장되고, 서버 연결이 가능하면 Firestore 제출함에도 저장됩니다.
