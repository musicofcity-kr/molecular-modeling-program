...
export const legalDocuments: Record<LegalDocumentId, LegalDocument> = {
  privacy: {
    ...
    summary:
      '본 서비스는 학생 회원가입을 요구하지 않으며, 학생 활동은 수업코드, 입장 확인코드, 수업용 닉네임 또는 익명 ID를 중심으로 처리합니다.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          '웹앱 사용 과정에서 수업코드, 입장 확인코드, 수업용 닉네임 또는 익명 ID, 활동 질문 응답, 학생이 그린 분자 구조 데이터, 구조 확인 결과가 브라우저 내부에서 처리될 수 있습니다.',
        ],
        items: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '이용자란 학생, 교사 및 기타 이용자를 말하며, 학생 이용자는 수업코드, 입장 확인코드, 수업용 닉네임 또는 익명 ID로 활동에 입장합니다.',
        ],
      },
      {
      ...
      },
      {
        title: '제6조 학생 이용',
        paragraphs: [
          '학생은 회원가입 없이 수업코드, 입장 확인코드, 수업용 닉네임 또는 익명 ID로 활동에 입장합니다. 실명, 학번, 전화번호, 이메일, 주소 등 불필요한 개인정보를 입력하지 않아야 합니다.',
